...
**Repository:** [github.com/edicorai/vibetown/engine](https://github.com/edicorai/vibetown/engine) (Go, the `gt` binary)
...
### Gas Town / Gas City
- [Gas Town GitHub](https://github.com/edicorai/vibetown/engine) — source for role templates at `internal/templates/roles/*.md.tmpl`
...
- [Gas Town glossary](https://github.com/edicorai/vibetown/engine/blob/main/docs/glossary.md)
...
- [Wasteland CLI PR #1552](https://github.com/edicorai/vibetown/engine/pull/1552)
