...
What happens today (with PR [#1759](https://github.com/edicorai/vibetown/engine/pull/1759)):
...
|---|---------|----------|--------|
| 7 | Blocked tasks get slung (blocks deps ignored) | `isIssueBlocked` | PR [#1759](https://github.com/edicorai/vibetown/engine/pull/1759) (open) |
| 8 | Epics get slung to polecats (no type filter) | `IsSlingableType` | PR [#1759](https://github.com/edicorai/vibetown/engine/pull/1759) (open) |
...
| 12 | First dispatch failure abandons entire convoy | Dispatch failure iteration | PR [#1759](https://github.com/edicorai/vibetown/engine/pull/1759) (open) |
...
1. **Now:** Get PR [#1759](https://github.com/edicorai/vibetown/engine/pull/1759) (feeder safety guards) reviewed and merged to
