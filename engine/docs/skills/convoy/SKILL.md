...
> Implemented in [PR #1820](https://github.com/edicorai/vibetown/engine/pull/1820). Depends on the feeder safety guards from [PR #1759](https://github.com/edicorai/vibetown/engine/pull/1759). Design docs: `docs/design/convoy/stage-launch/prd.md`, `docs/design/convoy/stage-launch/testing.md`.
