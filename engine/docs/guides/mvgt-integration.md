...
| evidence_url | text | NO | NULL | URL pointing to where completed work can be reviewed, e.g. `https://github.com/edicorai/vibetown/engine/pull/2328` |
...
| evidence | text | NO | NULL | Description of what was done, links to PRs, commits, or artifacts, e.g. `https://github.com/edicorai/vibetown/engine/pull/2328` |
