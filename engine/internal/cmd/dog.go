...
import (
	...
	"github.com/edicorai/vibetown/engine/internal/dog"
	"github.com/edicorai/vibetown/engine/internal/mail"
	"github.com/edicorai/vibetown/engine/internal/plugin"
...
func runDogDispatch(cmd *cobra.Command, args []string) error {
	...
	if _, sessErr := sessMgr.EnsureRunning(targetDog.Name, sessOpts); sessErr != nil {
		...
		// See: github.com/edicorai/vibetown/engine/issues/2748
		if clearErr := mgr.ClearWork(targetDog.Name); clearErr != nil {
